...
jQuery(document).ready(function($){
  ...
  var latitude = 36.850304,
      longitude = 10.2638633,
      map_zoom = 6;

  //google map custom marker icon - .png fallback for IE11
  var is_internetExplorer11= navigator.userAgent.toLowerCase().indexOf('trident') > -1;
  var marker_url = ( is_internetExplorer11 ) ? './assets/img/widgets/gmap/cd-icon-location.png' : 'img/widgets/gmap/cd-icon-location.svg';
